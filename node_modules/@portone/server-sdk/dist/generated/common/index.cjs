...
var _B2bExternalServiceError = require("./B2bExternalServiceError.cjs");
Object.keys(_B2bExternalServiceError).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _B2bExternalServiceError[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _B2bExternalServiceError[key];
    }
  });
});
var _B2bNotEnabledError = require("./B2bNotEnabledError.cjs");
Object.keys(_B2bNotEnabledError).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _B2bNotEnabledError[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _B2bNotEnabledError[key];
    }
  });
});
...
var _InformationMismatchError = require("./InformationMismatchError.cjs");
Object.keys(_InformationMismatchError).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _InformationMismatchError[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _InformationMismatchError[key];
    }
  });
});
