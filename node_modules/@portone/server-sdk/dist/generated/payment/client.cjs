...
exports.StopPaymentCancellationError = exports.ResendWebhookError = exports.RegisterStoreReceiptError = exports.PreRegisterPaymentError = void 0;
...
var _client4 = require("./additionalFeature/client.cjs");
var _client5 = require("./paymentSchedule/client.cjs");
var _client6 = require("./promotion/client.cjs");
function PaymentClient(init) {
  ...
  return {
    ...
    stopPaymentCancellation: async options => {
      const {
        paymentId,
        cancellationId,
        storeId
      ...
      const response = await fetch(new URL(`/payments/${encodeURIComponent(paymentId)}/cancellations/${encodeURIComponent(cancellationId)}/stop`, baseUrl), {
        method: "POST",
        headers: {
          Authorization: `PortOne ${secret}`,
          "User-Agent": _client.USER_AGENT
    ...
    additionalFeature: (0, _client4.AdditionalFeatureClient)(init),
    paymentSchedule: (0, _client5.PaymentScheduleClient)(init),
    promotion: (0, _client6.PromotionClient)(init)
  };
}
...
class StopPaymentCancellationError extends _PaymentError.PaymentError {
  /** @ignore */
  constructor(data) {
    super(data);
...
exports.StopPaymentCancellationError = StopPaymentCancellationError;
