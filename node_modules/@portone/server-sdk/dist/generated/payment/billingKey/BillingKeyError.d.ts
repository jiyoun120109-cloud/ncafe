...
import type { BillingKeyAlreadyIssuedError } from "../../payment/billingKey/BillingKeyAlreadyIssuedError.js";
...
import type { InformationMismatchError } from "../../common/InformationMismatchError.js";
...
export declare abstract class BillingKeyError extends PaymentError {
    readonly data: BillingKeyAlreadyDeletedError | BillingKeyAlreadyIssuedError | BillingKeyNotFoundError | BillingKeyNotIssuedError | ChannelNotFoundError | ChannelSpecificError | ForbiddenError | InformationMismatchError | InvalidRequestError | PaymentScheduleAlreadyExistsError | PgProviderError | UnauthorizedError | {
