...
Object.keys(_PlatformTransferSummaryPartnerType).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _PlatformTransferSummaryPartnerType[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _PlatformTransferSummaryPartnerType[key];
    }
  });
});
var _PlatformTransferSummaryPayment = require("./PlatformTransferSummaryPayment.cjs");
Object.keys(_PlatformTransferSummaryPayment).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _PlatformTransferSummaryPayment[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _PlatformTransferSummaryPayment[key];
    }
  });
});
var _PlatformTransferSummaryPortOnePayment = require("./PlatformTransferSummaryPortOnePayment.cjs");
Object.keys(_PlatformTransferSummaryPortOnePayment).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _PlatformTransferSummaryPortOnePayment[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _PlatformTransferSummaryPortOnePayment[key];
    }
  });
});
var _PlatformTransferType = require("./PlatformTransferType.cjs");
Object.keys(_PlatformTransferType).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _PlatformTransferType[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _PlatformTransferType[key];
    }
  });
});
var _PlatformUserDefinedPropertyKeyValue = require("./PlatformUserDefinedPropertyKeyValue.cjs");
Object.keys(_PlatformUserDefinedPropertyKeyValue).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _PlatformUserDefinedPropertyKeyValue[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _PlatformUserDefinedPropertyKeyValue[key];
    }
  });
});
var _TransferParameters = require("./TransferParameters.cjs");
Object.keys(_TransferParameters).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _TransferParameters[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _TransferParameters[key];
    }
  });
});
